CREATE TABLE IF NOT EXISTS unit_providers (
    ...
    provider_id INT REFERENCES unit_provider(id) NOT NULL
);CREATE TABLE IF NOT EXISTS unit_blocks (
    id serial PRIMARY KEY,
    block_name VARCHAR(255) NOT NULL,
    location_id INT REFERENCES unit_location(id) NOT NULL
);CREATE TABLE IF NOT EXISTS units (
    id serial PRIMARY KEY,
    name VARCHAR(225) NOT NULL,
    block_id INT REFERENCES unit_block(id),
    ...
    unit_provider_id INT REFERENCES unit_provider(id) NOT NULL
);
